...
//    display.print(", 4:"); display.println(keyPressed[3]);
//
...
//
//    display.println("LPS");
//    display.print(distance_data[0]);   display.print(" ");
//    display.print(distance_data[1]);   display.print(" ");
//    display.print(distance_data[2]);   display.print(" ");
//    display.println();
//
//    display.display();
//
