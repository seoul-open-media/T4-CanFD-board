...
void loop() {
  ...
  setI2SFreq(48000);
  playFile("at_sea_24_48000.wav"); // Linear PCM, 24 bit little-endian signed integer, 48000 Hz, 2 Channels
  sgtl5000_1.volume(0.6);
  delay(500);
  setI2SFreq(44100);
  playFile("Nums_7dot1_16_44100.wav"); // Linear PCM, 16 bit little-endian signed integer, 44100 Hz, 8 Channels
  delay(500);
  setI2SFreq(48000);
  playFile("evening_16_48000.wav"); // Linear PCM, 16 bit little-endian signed integer, 48000 Hz, 2 Channels
  delay(500);
  setI2SFreq(44100);
  playFile("Nums_7dot1_8_44100.wav"); // Linear PCM, 8 bit unsigned integer, 44100 Hz, 8 Channels
  delay(500);
  setI2SFreq(48000);
  playFile("walk_at_Salzach_24_48000.wav"); // Linear PCM, 24 bit little-endian signed integer, 48000 Hz, 2 Channels
  delay(500);
  setI2SFreq(44100);
  playFile("sine110.wav"); // Linear PCM, 16 bit little-endian signed integer, 44100 Hz, 1 Channel
  delay(500);
